...
function loadRankPageOne() {
    ...
    function loadUsers(page, topRank) {
        ...
        $.ajax({
            url: `http://115.85.182.117:8081/api/reviewer-rank${queryString}`,
            type: "GET",
            dataType: "json",
...
function followUser(userId, loginUserId, followedId) {
    ...
    $.ajax({
        url: `http://115.85.182.117:8081/mypage/${userId}/follow`,
        type: "POST",
...
function unfollowUser(userId, loginUserId, followedId) {
    ...
    $.ajax({
        url: `http://115.85.182.117:8081/mypage/${userId}/unfollow?loginUserId=${loginUserId}&followedId=${followedId}`,
        type: "DELETE",
        success: function() {
