...
async function productReviewCommentRead(e) {
    ...
    const response = await fetch('http://115.85.182.117:8081/products/comment/'+e.id);
...
async function registerComment (e) {
    ...
    const response = await fetch('http://115.85.182.117:8081/products/comment/', {
        method:'POST',
        headers: {
...
async function commentDelete (e) {
    ...
    const response = await fetch('http://115.85.182.117:8081/products/comment/'+commentId, {
        method:'DELETE'
    });
    const data = await response.json();
