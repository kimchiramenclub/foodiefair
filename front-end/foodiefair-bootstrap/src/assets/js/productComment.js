...
async function productReviewCommentRead(e) {
    ...
    const response = await fetch('https://www.foodiefair.shop/products/comment/'+e.id);
...
async function registerComment (e) {
    ...
    const response = await fetch('https://www.foodiefair.shop/products/comment/', {
        method:'POST',
        headers: {
...
async function commentDelete (e) {
    ...
    const response = await fetch('https://www.foodiefair.shop/products/comment/'+commentId, {
        method:'DELETE'
    });
    const data = await response.json();
