...
async function fetchVisitedList(userId, page = 1, size = 5) {
    const response = await fetch(`http://115.85.182.117:8081/mypage/${userId}/visited?page=${page}&size=${size}`);
...
async function registerVisited(ownerId, visitedContent) {
    try {
        ...
        const response = await fetch(`http://115.85.182.117:8081/mypage/${ownerId}/visited`, {
            method: "POST",
            headers: {
...
async function deleteVisited(visitedId, currentPage, pageSize) {
    try {
        const response = await fetch(`http://115.85.182.117:8081/mypage/${userId}/visited/${visitedId}`, {
            method: "DELETE",
        });
