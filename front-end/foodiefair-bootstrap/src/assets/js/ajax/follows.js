...
async function fetchFollowData(userId, type, lastFollowId, perPage, loginUserId) {
    try {
        const response = await $.ajax({
            url: `https://www.foodiefair.shop/mypage/${userId}/${type}`,
            method: 'GET',
            dataType: 'json',
            data: {
...
async function fetchFollowCount(userId, type) {
    try {
        const response = await $.ajax({
            url: `https://www.foodiefair.shop/mypage/${userId}/${type}/count`,
            method: 'GET',
            dataType: 'json',
        });
...
async function followUser(userId, loginUserId, followedId) {
    ...
    const response = await fetch(`https://www.foodiefair.shop/mypage/${userId}/follow`, {
        method: 'POST',
        headers: {
...
async function unfollowUser(userId, loginUserId, followedId) {
    const response = await fetch(`https://www.foodiefair.shop/mypage/${userId}/unfollow?loginUserId=${loginUserId}&followedId=${followedId}`, {
        method: 'DELETE',
    });
...
async function fetchUserBadges(userId) {
    try {
        const response = await fetch(`https://www.foodiefair.shop/mypage/${userId}/userSelectedBadge`);
