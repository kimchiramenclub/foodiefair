...
async function fetchFollowData(userId, type, lastFollowId, perPage, loginUserId) {
    try {
        const response = await $.ajax({
            url: `http://115.85.182.117:8081/mypage/${userId}/${type}`,
            method: 'GET',
            dataType: 'json',
            data: {
...
async function fetchFollowCount(userId, type) {
    try {
        const response = await $.ajax({
            url: `http://115.85.182.117:8081/mypage/${userId}/${type}/count`,
            method: 'GET',
            dataType: 'json',
        });
...
async function followUser(userId, loginUserId, followedId) {
    ...
    const response = await fetch(`http://115.85.182.117:8081/mypage/${userId}/follow`, {
        method: 'POST',
        headers: {
...
async function unfollowUser(userId, loginUserId, followedId) {
    const response = await fetch(`http://115.85.182.117:8081/mypage/${userId}/unfollow?loginUserId=${loginUserId}&followedId=${followedId}`, {
        method: 'DELETE',
    });
...
async function fetchUserBadges(userId) {
    try {
        const response = await fetch(`http://115.85.182.117:8081/mypage/${userId}/userSelectedBadge`);
