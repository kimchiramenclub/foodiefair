...
public class NaverCombineKorean {
    ...
    public static void main(String[] args) throws IOException {
        String text = "달콤하다. 달짝지근하다. 짜다. 짭조름하다. 닝닝하다. 느끼하다. 타분하다. 밍밍하다.";
    ...
    //긍정 키워드
    public static List<String> extractPositiveKeywords(String text) throws IOException {
    ...
    //부정 키워드
    public static List<String> extractNegativeKeywords(String text) throws IOException {
        OkHttpClient client = new OkHttpClient();
        MediaType mediaType = MediaType.parse("application/json; charset=utf-8");
        String jsonBody = "{\"content\":\"" + text + "\"}";
        RequestBody body = RequestBody.create(mediaType, jsonBody);
