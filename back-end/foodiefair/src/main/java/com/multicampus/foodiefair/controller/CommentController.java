...
public class CommentController {
    ...
    public ResponseEntity<Integer> commentDelete(@PathVariable long commentId) {
        log.info(commentId);
    ...
    @GetMapping("/{reviewId}")
    public ResponseEntity<List<Map<String, Object>>> commentRead(@PathVariable long reviewId) {
